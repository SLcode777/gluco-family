...
inline const char *LangES = R"====(
{
  ...
  "LibreToU":"LibreLinkUp: acepte las nuevas condiciones en la aplicación",
  "LibreNoMatch":"Ningún paciente LibreLinkUp encontrado para ",
  ...
  "GlucoOn":"Gluco-Family activo desde: ",
  "Cancel":"Cancelar",
